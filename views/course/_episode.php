                            ...
                            <div class="ocplayerlink">
                                <? if ($GLOBALS['perm']->get_studip_perm($course_id) == 'autor') : ?>
                                    <?= Studip\LinkButton::create(
                                        $_('Feedback'),
                                        'mailto:' . 'opencast@elearning.uni-bremen.de' . '?subject=[Opencast] Feedback&body=%0D%0A%0D%0A%0D%0ALink zum betroffenen Video:%0D%0A' . 'https://elearning.uni-bremen.de/'.PluginEngine::getLink('opencast/course/index/' . $item['id']),
                                        [
                                            'class' => 'oc_feedback'
                                        ]
                                    ); ?>
